...
@Component({
    selector: 'app-withdraw-lab-switch-token-option-field',
    templateUrl: './withdraw-lab-switch-token-option-field.component.html',
    styleUrls: ['./withdraw-lab-switch-token-option-field.component.sass']
})
export class WithdrawLabSwitchTokenOptionFieldComponent
    extends TokenOptionField<WithdrawLabSwitchTokenOption>
    implements OnInit
{
    private _value?: TokenOptionGroup | WithdrawLabSwitchTokenOption;
    ...
    public set initValue(initValue: WithdrawLabSwitchTokenOption | TokenOptionGroup) {
    ...
    public async getValue(): Promise<WithdrawLabSwitchTokenOption> {
        if (
            !this._value ||
            !this._idField ||
            !this._nameField ||
