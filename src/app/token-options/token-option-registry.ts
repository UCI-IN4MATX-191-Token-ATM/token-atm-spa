...
export class TokenOptionRegistry {
    private static DESCRIPTIVE_NAME_REGISTRY: {
        ...
        'spend-for-assignment-resubmission': 'Spend Tokens for Assignment Resubmission', // TODO: state 'Canvas Assignment' or 'on Canvas'
        'withdraw-assignment-resubmission': 'Withdraw Assignment Resubmission Request', // TODO: same as above
