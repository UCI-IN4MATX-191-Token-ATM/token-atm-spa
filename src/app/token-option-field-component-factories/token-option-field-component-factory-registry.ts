...
export class TokenOptionFieldComponentFactoryRegistry {
    ...
    public static registerFieldComponentFactory<T extends TokenOption>(
        factory: Type<TokenOptionFieldComponentFactory<T>>
    ) {
        REGISTERED_TOKEN_OPTION_FIELD_COMPONENT_FACTORIES.push(factory);
    }
}
